      ...
      <div className="mt-6 space-y-6 text-body text-ink-muted">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            beställning, till exempel namn, adress och kontaktuppgifter. Vid
        ...
        <section>
          ...
          <p className="mt-2">
            Uppgifterna används för att hantera dina köp, ge dig kundservice
            och, om du valt det, skicka erbjudanden. Betalning och
            orderhantering sker via Shopify.
          </p>
        </section>
        <section>
