 ...
 */
const DEFAULT_ANGERRATT = "14 dagars ångerrätt enligt distansavtalslagen. Retur i oanvänt skick.";
...
function buildProduct(seed: SeedInput, index: number): Product {
  ...
  const createdAt = new Date(REFERENCE_MS - seed.daysAgo * 24 * 60 * 60 * 1000).toISOString();
...
const SEEDS: SeedInput[] = [
  ...
  },
  {
    ...
    hue: 45,
    daysAgo: 5,
    description: "Små ringörhängen i guldton. Den där lagom-storleken som passar till precis allt.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 12,
    daysAgo: 8,
    description: "Handmålad emaljblomma i varma toner. Retro-vibbar rakt av.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 20,
    daysAgo: 10,
    description: "Ett litet kluster av pärlor i olika storlekar. Romantiskt utan att bli sött.",
    vintageStory:
  ...
  /* ---------------------------- HALSBAND ---------------------------- */
  {
    ...
    hue: 25,
    daysAgo: 2,
    description: "Kort pärlchoker som sitter fint mot halsen. Den nya klassikern.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 340,
    daysAgo: 7,
    description: "Öppningsbar medaljong i hjärtform. Gömställe för ett litet minne.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 190,
    daysAgo: 9,
    description: "En enda färgad sten på tunn kedja. Enkelt statement i turkos.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 30,
    daysAgo: 11,
    description: "Extra långt pärlband att snurra dubbelt. 20-talsenergi hela vägen.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 50,
    daysAgo: 3,
    description: "Fin kedja med små kulor jämnt fördelade. Diskret men detaljrik.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 320,
    daysAgo: 6,
    description: "Armband med små berlocker: hjärta, nyckel och stjärna. Fyll på med minnen.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 205,
    daysAgo: 10,
    description: "Rad av glittrande kristaller hela vägen runt. Diskret lyx-känsla.",
    vintageStory:
  ...
  },
  {
    ...
    vintageStory: "En klassisk form ur deadstock. Signetringar som väntar på sitt första finger.",
    tags: ["ring", "minimal"],
    metals: ["Guld", "Silver"],
  },
  {
    ...
    vintageStory: "En pärla för fingret. Ringar ur konkurslagret som legat orörda i sina askar.",
    tags: ["ring", "pärla"],
  },
  {
  ...
  },
  {
    ...
    hue: 320,
    daysAgo: 6,
    description: "Nyckelring med små berlocker. Lite smycke även på nyckelknippan.",
    vintageStory:
  ...
  },
  {
    ...
    hue: 200,
    daysAgo: 8,
    description: "Pärlkedja för solglasögonen. Praktiskt och snyggt på samma gång.",
    vintageStory:
  ...
  /* ------------------------- TILLBEHÖR (dropship) ------------------------- */
  {
    handle: "smyckestrad-guldgruvan",
    title: "Smyckesträd 'Guldgruvan'",
    category: "smyckeshallare",
    price: 79,
    stock: 25,
    hue: 40,
    daysAgo: 1,
    description:
      "Ett smyckesträd i metall med flera grenar för halsband och örhängen, en plats där fynden syns.",
    vintageStory: "",
    tags: ["smyckeshallare"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
  },
  {
    handle: "smyckesskrin-skattkistan",
    title: "Smyckesskrin 'Skattkistan'",
    category: "smyckeshallare",
    price: 69,
    stock: 25,
    hue: 40,
    daysAgo: 1,
    description:
      "Ett kompakt skrin med mjukt foder, fack för ringar och örhängen samt plats för ett par halsband.",
    vintageStory: "",
    tags: ["smyckeshallare"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
  ...
  {
    handle: "orhangesstall-rampljuset",
    title: "Örhängesställ 'Rampljuset'",
    category: "smyckeshallare",
    price: 59,
    stock: 25,
    hue: 40,
    daysAgo: 1,
    description:
      "Ett ställ i klar akryl med flera rader som visar upp hela örhängessamlingen på en gång.",
    vintageStory: "",
    tags: ["smyckeshallare"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
  ...
  {
    handle: "polerduk-nyputsat",
    title: "Polerduk 'Nyputsat'",
    category: "smyckesrengoring",
    price: 39,
    stock: 40,
    hue: 200,
    daysAgo: 1,
    description:
      "En mjuk mikrofiberduk som varsamt putsar bort matthet och fingeravtryck från silver, guldpläterat och stål.",
    vintageStory: "",
    tags: ["smyckesrengoring"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
  },
  {
    handle: "polerdukar-3-pack-blanket",
    title: "Polerdukar 3-pack 'Blänket'",
    category: "smyckesrengoring",
    price: 49,
    stock: 40,
    hue: 200,
    daysAgo: 1,
    description:
      "Tre mjuka polerdukar som håller fynden blanka utan repor. Fungerar på silver, guldpläterat och de flesta metaller.",
    vintageStory: "",
    tags: ["smyckesrengoring"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
  ...
  {
    handle: "rengoringskit-fraschoren",
    title: "Rengöringskit 'Fräschören'",
    category: "smyckesrengoring",
    price: 69,
    stock: 25,
    hue: 200,
    daysAgo: 1,
    description:
      "Ett litet kit med rengöringslösning, mjuk borste och polerduk som lyfter fram glansen i vintagefynd.",
    vintageStory: "",
    tags: ["smyckesrengoring"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
  ...
  {
    handle: "presentaskar-5-pack-inslaget",
    title: "Presentaskar 5-pack 'Inslaget'",
    category: "presentforpackningar",
    price: 49,
    stock: 40,
    hue: 320,
    daysAgo: 1,
    description:
      "Fem små askar i kraftpapper med mjuk vaddering, i rätt storlek för örhängen, ringar och armband.",
    vintageStory: "",
    tags: ["presentforpackning"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
  },
  {
    handle: "sammetspasar-5-pack-lilla-lyxen",
    title: "Sammetspåsar 5-pack 'Lilla lyxen'",
    category: "presentforpackningar",
    price: 39,
    stock: 40,
    hue: 320,
    daysAgo: 1,
    description:
      "Fem mjuka påsar i sammet med dragsko, som skyddar fynden i väskan eller blir en present i sig.",
    vintageStory: "",
    tags: ["presentforpackning"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
  ...
  {
    handle: "presentask-stora-dagen",
    title: "Presentask 'Stora dagen'",
    category: "presentforpackningar",
    price: 59,
    stock: 25,
    hue: 320,
    daysAgo: 1,
    description:
      "En stadig presentask med lock och mjukt foder som rymmer ett halsband eller flera mindre smycken.",
    vintageStory: "",
    tags: ["presentforpackning"],
    isDropship: true,
    customsNote: "Skickas direkt från leverantör, leveranstid 5 till 10 dagar.",
...
export const MOCK_PRODUCTS: Product[] = SEEDS.map((seed, i) => buildProduct(seed, i));
